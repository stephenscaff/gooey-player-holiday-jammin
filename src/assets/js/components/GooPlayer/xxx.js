 ...
 *
 * v1.2 slightly modified to handle Chrome 71's audio context autoplay changes
 * with strict user interactin reqs. Solution was to resume audiocontext within
